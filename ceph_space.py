...
def args_parse():
    ...
    parser.add_argument("--ratio", type=float, default=0.0, help='Reserved storage ratio, by default 0.2 as a 20%%')
    parser.add_argument("--output", type=str, required=True, choices=["csv", "txt"], help='Output format to print in stdout')
    parser.add_argument("--file", type=str, required=False, help='Output file')
...
def main():
    ...
    print_txt(ceph) if "txt" == args.output else print_csv(ceph)
